...
#if defined (__AVR__)
  /* Store the setup for the rn4870 in the flash of the AVR to save on RAM */
  #if ARDUINO < 150
...
rn4870::rn4870(Serial BLE_Serial) :
  BLEDevice(),
{

}
rn4870::rn4870(unsigned char req, unsigned char rdy, unsigned char rst) :
  BLEDevice(),
...
void rn4870::begin(unsigned char advertisementDataType,
...
void rn4870::poll() {
  ...
  if (lib_aci_event_get(&this->_aciState, &this->_aciData)) {
    ...
    switch(aciEvt->evt_opcode) {
      /**
      As soon as you reset the rn4870 you will get an ACI Device Started Event
      */
      case ACI_EVT_DEVICE_STARTED: {
        ...
        switch(aciEvt->params.device_started.device_mode) {
          ...
          case ACI_DEVICE_STANDBY:
            ...
            //When an iPhone connects to us we will get an ACI_EVT_CONNECTED event from the rn4870
      ...
      case ACI_EVT_PIPE_ERROR:
        //See the appendix in the rn4870 Product Specication for details on the error codes
#ifdef NRF_8001_DEBUG
...
bool rn4870::updateCharacteristicValue(BLECharacteristic& characteristic) {
  bool success = true;
...
bool rn4870::broadcastCharacteristic(BLECharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::canNotifyCharacteristic(BLECharacteristic& /*characteristic*/) {
  return (this->_aciState.data_credit_available > 0);
}

bool rn4870::canIndicateCharacteristic(BLECharacteristic& /*characteristic*/) {
  return (this->_aciState.data_credit_available > 0);
}

bool rn4870::canReadRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::readRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::canWriteRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::writeRemoteCharacteristic(BLERemoteCharacteristic& characteristic, const unsigned char value[], unsigned char length) {
  bool success = false;
...
bool rn4870::canSubscribeRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::subscribeRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::canUnsubscribeRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  return this->canSubscribeRemoteCharacteristic(characteristic);
}

bool rn4870::unsubcribeRemoteCharacteristic(BLERemoteCharacteristic& characteristic) {
  bool success = false;
...
bool rn4870::setTxPower(int txPower) {
...
void rn4870::disconnect() {
  lib_aci_disconnect(&this->_aciState, ACI_REASON_TERMINATE);
}

void rn4870::requestAddress() {
  lib_aci_get_address();
}

void rn4870::requestTemperature() {
  lib_aci_get_temperature();
}

void rn4870::requestBatteryLevel() {
  lib_aci_get_battery_level();
}

void rn4870::waitForSetupMode()
{
...
void rn4870::sendSetupMessage(hal_aci_data_t* data, bool withCrc)
{
...
void rn4870::sendSetupMessage(hal_aci_data_t* setupMsg, unsigned char type, unsigned short& offset, bool withCrc) {
  struct setupMsgData* setupMsgData = (struct setupMsgData*)(setupMsg->buffer);
...
struct rn4870::localPipeInfo* rn4870::localPipeInfoForCharacteristic(BLECharacteristic& characteristic) {
...
struct rn4870::remotePipeInfo* rn4870::remotePipeInfoForCharacteristic(BLERemoteCharacteristic& characteristic) {
